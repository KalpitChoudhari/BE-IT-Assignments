airquality = read.csv("/home/rootnova/Desktop/DSBDA/Assignment 8/AirQualityUCI.csv")
iris=read.csv("/home/rootnova/Desktop/DSBDA/Assignment 8/Iris.csv")
heart=read.table("/home/rootnova/Desktop/DSBDA/Assignment 8/HeartDatasetDesc.txt")
summary(heart)
print(airquality)
